...
<head>
    ...
    <link rel="shortcut icon" href="myphp/img/DONKEY AIR.svg" type="image/x-icon">
...
<nav class="p-1 mb-2 bg-dark text-white">
        ...
        <div class="d-flex">
            <div class="p-2">       
            <a class="navbar-brand" href="homepage.php"><img src="myphp/img/DONKEY AIR.svg" alt="Logo" width="80" height="80"></a></div>
